...
q_dof = 2
data = torch.load('/Users/yash/Documents/Northeastern/EECE5550/Project /Code/OptimalModulationDS-master/python_scripts/mlp_learn/datasets/%dd_toy_data.pt' % q_dof).to(**tensor_args)
x = data[:, 0:q_dof + 3]
y = data[:, -q_dof:]

#update size and layers as needed. In our case it's 256x5 for 7dof and 2dof toy
s = 256
n_layers = 5
skips = []
